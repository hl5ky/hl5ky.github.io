...
호주 유학을 준비하던 무렵, 김윤희는 우연한 기회에 대학 선배인 나(HL5KY)와 전파를 통해 운명처럼 마주하게 되었다. 같은 캠퍼스에 다녔지만 서로 알지 못했던 두 사람이 무선이라는 보이지 않는 다리를 통해 처음 만난 셈이었다. 만남의 계기는 뜻밖이었다. 그녀는 모교 클럽국(HL0M) 동기들과 매주 정기적인 스케줄 교신을 나누고 있었는데, 마침 내가 그 동기 중 한 명인 HL5BCT의 집을 방문했다가 우연히 마이크를 넘겨받게 된 것이었다.
